...
1. Go to your GitHub account and create a new repo on your account and [add your partner as a collaborator](https://help.github.com/en/github/setting-up-and-managing-your-github-user-account/inviting-collaborators-to-a-personal-repository). Initialising it with a `README.md`.
